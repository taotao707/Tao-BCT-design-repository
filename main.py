...
parser.add_argument('--world-size', default=-1, type=int, #world_size
...
parser.add_argument('--gpu', default=None, type=int,
                    help='GPU id to use.')
parser.add_argument('--multiprocessing-distributed', action='store_true', #multiprocessing_distributed
...
parser.add_argument('--old-arch', metavar='ARCH', default='resnet18',
                    ...
                    ' | '.join(model_names) +
                    ' (default: resnet18)')
parser.add_argument('--old-checkpoint', default=None, type=str, metavar='PATH', #old_checkpoint
